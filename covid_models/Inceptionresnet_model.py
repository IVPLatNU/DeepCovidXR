...
class InceptionResNet():
    """
    This is a class for building various Inception-ResNet-V2 model for different usage,
    ...
    def __init__(self, weights):
        """ 
        The constructor for InceptionResNet class. 
    ...
    def buildBaseModelFast(self):
        """
        This function loads an Inception-ResNet-V2 model.
    ...
    def freeze(self, model):
        """
        This function builds a Inception-ResNet-V2 model with layers other than fully 
        ...
        Returns:
            model (class): the Inception-ResNet-V2 model with fully connected layers as 
